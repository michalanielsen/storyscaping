...
class UniteCreatorManagerAddonsWork extends UniteCreatorManager{
	...
	private function putPreviewTemplateDialog(){
		...
		<div id="uc_dialog_preview_template" class="uc-dialog-preview-template unite-inputs" title="<?php echo esc_attr($dialogTitle)?>" style="display:none;">
			<div class="uc-dialog-preview-template__header">
				
				<?php $this->putHtmlHeaderLogo()?>
				
				<a href="javascript:void(0)" class="uc-dialog-preview-template__button-close"> &lt; <?php _e("Back to the catalog", "unlimited_elements")?></a>
				
			</div>
			<div class="uc-dialog-preview-template__content">
				...
				<div class="uc-dialog-preview-template__right">
					...
					<p>
						<?php _e("Import this template to make it available in your Elementor Saved Templates list for future use.","unlimited_elements")?>
					</p>
					
					<br>
					
					<a href="javascript:void(0)" class="unite-button-primary uc-dialog-preview-template__button-import"><?php _e("Import Template","unlimited_elements")?></a>
					<div id="uc_dialog_import_template_loader" class="uc-dialog-preview-template__loader" style="display:none"><?php _e("Importing Template","unlimited_elements")?>...</div>
					...
					<span id="uc_dialog_import_template_createpage_loader" class="uc-dialog-preview-template__createpage-loader" style="display:none"><?php _e("Importing Template","unlimited_elements")?>...</span>
					<span id="uc_dialog_import_template_createpage_success" class="uc-dialog-preview-template__createpage-success" style="display:none"></span>
