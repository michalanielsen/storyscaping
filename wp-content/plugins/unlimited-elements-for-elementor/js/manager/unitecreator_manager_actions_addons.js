...
function UCManagerActionsAddons(){
	...
	function previewDialog_onCreatePageClick(){
		...
		g_ucAdmin.setSuccessMessageID("uc_dialog_import_template_createpage_success");
	...
	function initEvents(){
		...
		if(g_objDialogPreviewTemplate){
			...
			var objButtonClose = g_objDialogPreviewTemplate.find(".uc-dialog-preview-template__button-close");
